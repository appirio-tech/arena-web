...
export STATIC_FILE_HOST="https://arena.topcoder.com"

# The tc auth host url
export TC_AUTH_URL="https://accounts-auth0.topcoder.com"

# Web socket server url
# This url should map to 5016 port of arena-app service, e.g by using load balancer.
export WEB_SOCKET_URL="https://arenaws.topcoder.com"

# TC-api url
export API_DOMAIN="https://api.topcoder.com"
...
export PW_RESET_URL='https://www.topcoder.com/password-recovery/'
